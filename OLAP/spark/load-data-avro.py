pyspark --num-executors 1  --executor-memory 10g  --packages org.apache.spark:spark-avro_2.11:2.3.0
...
nation = spark.read.load("hdfs://namenode:8020/nation.avro", format="com.databricks.spark.avro");
region = spark.read.load("hdfs://namenode:8020/region.avro", format="com.databricks.spark.avro");
supplier = spark.read.load("hdfs://namenode:8020/supplier.avro", format="com.databricks.spark.avro");
partsupp = spark.read.load("hdfs://namenode:8020/partsupp.avro", format="com.databricks.spark.avro");
part = spark.read.load("hdfs://namenode:8020/part.avro", format="com.databricks.spark.avro");
customer = spark.read.load("hdfs://namenode:8020/customer.avro", format="com.databricks.spark.avro");
orders = spark.read.load("hdfs://namenode:8020/orders.avro", format="com.databricks.spark.avro");
lineitem = spark.read.load("hdfs://namenode:8020/lineitem.avro", format="com.databricks.spark.avro");