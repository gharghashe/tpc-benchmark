...
df.write.mode("overwrite").format("orc").save("hdfs://namenode:8020/nation.orc")
...
df.write.mode("overwrite").format("orc").save("hdfs://namenode:8020/supplier.orc")
...
df.write.mode("overwrite").format("orc").save("hdfs://namenode:8020/partsupp.orc")
...
df.write.mode("overwrite").format("orc").save("hdfs://namenode:8020/part.orc")
...
df.write.mode("overwrite").format("orc").save("hdfs://namenode:8020/customer.orc")
...
df.write.mode("overwrite").format("orc").save("hdfs://namenode:8020/orders.orc")
...
df.write.mode("overwrite").format("orc").save("hdfs://namenode:8020/lineitem.orc")

from pyspark.sql import functions as func
nation = spark.read.load("hdfs://namenode:8020/nation.orc", format="orc");
region = spark.read.load("hdfs://namenode:8020/region.orc", format="orc");
supplier = spark.read.load("hdfs://namenode:    8020/supplier.orc", format="orc");
partsupp = spark.read.load("hdfs://namenode:8020/partsupp.orc", format="orc");
part = spark.read.load("hdfs://namenode:8020/part.orc", format="orc");
customer = spark.read.load("hdfs://namenode:8020/customer.orc", format="orc");
orders = spark.read.load("hdfs://namenode:8020/orders.orc", format="orc");
lineitem = spark.read.load("hdfs://namenode:8020/lineitem.orc", format="orc");